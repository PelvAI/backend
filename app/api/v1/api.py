...
api_router.include_router(orgs.router, tags=["orgs"])  # Orgs has top level /orgs and /my-links
...
api_router.include_router(admin_chat.router, prefix="/admin", tags=["admin-chat"])
